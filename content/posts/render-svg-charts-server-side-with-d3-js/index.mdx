...
<Alert>
  ...
  This blog post is really old.
  Here's a more recent post about this topic: <br />
  <a href="2020/05/render-charts-server-side-with-d3-and-node">Render charts server-side with D3 and Node in 2020</a>
</Alert>
